...
- Fixed infinite loop in SmartDiagnostics when watching its own output channel

## [0.1.2] - 2026-02-03

### Fixed

- Fixed extension failing to load by including `node_modules` dependencies in VSIX package

## [0.1.1] - 2026-02-03

### Fixed

- Fixed "command 'vokt.refreshSpecs' not found" error by registering the missing `voktSpecs.refresh` command that the refresh specs command depends on
